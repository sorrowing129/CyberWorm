...
function Gen(){
			sum=10;
       		...
       		BombDmg=0;
       		Win=0;
       		PlayTime = Random.Range(8.0,24.0);
       		FB = Random.Range(2,6);
       		 
       		 FireDmg = Random.Range(0,5);
       		 sum-=FireDmg;
       		 if (sum<=0)
			{
			Debug.Log(round);
